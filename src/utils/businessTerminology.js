...
const automotive = {
  ...
  stockTitle: "Repuestos facturados",
  stockEmpty: "No hay repuestos facturados para mostrar.",
...
const serviceBusiness = {
  ...
  stockTitle: "Materiales facturados",
  stockEmpty: "No hay materiales facturados para mostrar.",
