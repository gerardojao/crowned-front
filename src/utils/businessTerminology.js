...
const automotive = {
  ...
  managementSubtitle: "Accede rápido a las operaciones principales del día.",
  customerAndAssetTitle: "Datos del cliente y vehículo",
  customerPageSubtitle: "Gestiona clientes y vehículos del taller.",
  assetSingular: "vehículo",
  assetHeader: "Vehiculo",
  referenceLabel: "Matricula",
  referencePlaceholder: "Matricula *",
  referenceSearchPlaceholder: "Buscar matrícula...",
  referenceRequiredMessage: "Indica la matrícula del vehículo para registrar el cliente.",
  makeLabel: "Marca",
  modelLabel: "Modelo",
  modelRequiredMessage: "Indica el modelo del vehículo para registrar el cliente.",
  metricLabel: "Kilometraje",
  metricPlaceholder: "Kilometraje",
  partsLabel: "Repuestos",
  partsPlaceholder: "Repuestos €",
  stockTitle: "Stock / Rentabilidad",
  stockEmpty: "No hay repuestos para mostrar.",
  supplierHint: "Repuestos, pintura, neumaticos...",
  orderTitle: "Nueva orden de trabajo",
  orderSubtitle: "Registra trabajos, vehículo, estado y costes del servicio.",
...
const serviceBusiness = {
  ...
  managementSubtitle: "Coordina visitas, presupuestos, materiales y facturación.",
